    ...
    <main className="min-h-dvh bg-background text-foreground relative overflow-hidden">
      ...
      <header className="relative z-10 mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-5">
        ...
        <nav className="flex items-center gap-2">
          <label className="theme-switch theme-switch--compact" aria-label="Toggle theme">
            <input
              type="checkbox"
          ...
          <Link
            ...
            className={cn(
              ...
              'group relative overflow-hidden rounded-md bg-accent px-3 py-2 text-sm font-medium text-accent-foreground transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-glow active:scale-[0.98]',
            )}
          >
